...
- Basedash doesn’t send any of your response data to third-party AI providers. We only share metadata about your data source, like the table and column names available to query.
