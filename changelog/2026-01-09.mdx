...
description: "Dashboard folders with sharing, custom chart colors, powerful table exports, and new Public API endpoints."
---
...
> Note that the public API is in private beta. Contact us for access.
