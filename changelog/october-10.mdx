...
Archive reports with a "Recently deleted" view. Time series charts now use dashed visuals for partial periods. AI chat is faster with database schema caching.
