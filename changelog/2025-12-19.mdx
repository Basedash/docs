...
Basedash now has a [Public API](https://www.basedash.com/docs/api-reference/overview) so you can automate your Basedash setup and maintenance. You can create, fetch, and update organizations; upload an organization image; and manage embedding-related org settings via API.
...
<Note>
  The public API is currently in private beta. Contact us at
  support@basedash.com to request access.
</Note>

## Full-app embedding: safer setup, clearer failures, better iframe support (private beta)

[Full-app embedding](https://www.basedash.com/docs/features/embedding) complements our dashboard embedding offering by allowing you to not only embed a single dashboard in an iframe, but embed your whole Basedash app in an iframe—so you can tightly integrate Basedash with your existing products.
...
<Note>
  Full-app embedding is currently in private beta. Contact us at
  support@basedash.com to request access.
</Note>
