...
We overhauled chat navigation (right-side list + full-screen), added private/shared controls with a persistent filter, shipped major charts-in-chat actions (add to dashboard, export/PNG), and more.
