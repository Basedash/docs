...
New Databricks connector, a new 'More' menu on mobile for account/org actions, clearer database error messages, and Fivetran connectors now visible in the Data tab.
