...
<Card title="Complete guide" icon="circle-check">
  You've now completed the comprehensive startup metrics guide. Remember: start
  with one primary KPI, add supporting secondary metrics, and focus on
  actionable insights that drive your business forward. The key to success is
  consistent measurement, clear communication, and data-driven decision making.
</Card>
