...
<Card title="Next steps" icon="arrow-right">
  Growth brings new users, but keeping them is equally important. Learn about
  [retention and churn](/startup-metrics/retention-churn) to understand how well
  you maintain your growing user base.
</Card>
