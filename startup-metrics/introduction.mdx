...
Everything else is secondary. This doesn't mean other metrics aren't important—they help you understand _why_ your primary metric is moving—but they shouldn't distract from the main goal.
...
Your primary metric tells you _what_ is happening. Secondary metrics tell you _why_:
...
<Card
  ...
  icon="seedling"
  href="/startup-metrics/metrics-by-stage#pre-product-market-fit"
>
  Focus on learning and iteration speed. Track user engagement, feature
  adoption, and feedback quality over revenue metrics.
</Card>

<Card
  title="Post-product market fit"
  icon="chart-line-up"
  href="/startup-metrics/metrics-by-stage#early-product-market-fit"
>
  Focus on scalable growth. Track unit economics, operational efficiency, and
...
<Card
  title="Scale stage"
  icon="building"
  href="/startup-metrics/metrics-by-stage#scaling-growth"
>
  Focus on market expansion and operational excellence. Track market share, team
...
<Card title="Next steps" icon="arrow-right">
  Start with [metrics by stage](/startup-metrics/metrics-by-stage) to understand
  what to focus on at your current startup phase, or jump into [product
  metrics](/startup-metrics/product-metrics) if you're ready to dive into
  specifics.
</Card>
