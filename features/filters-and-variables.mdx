...
The JWT secret used to sign tokens is the same secret used for [full app embedding](/features/embedding#step-1-enable-embedding). You can find it at **Settings → Embedding** after enabling full app embedding.
...
- [Embedding](/features/embedding) - Embed dashboards or the full app, and find your JWT secret for secure filtering
