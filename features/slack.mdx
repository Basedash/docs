...
[Reports](/features/autopilot) can be configured to send notifications to Slack channels when they're generated. This keeps your team informed about scheduled reports without requiring them to check Basedash manually.
