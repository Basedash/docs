...
Self-hosted deployments also support SSO integration. For organizations using [self-hosting](/essentials/self-hosting), we can configure SSO with your existing identity providers. Contact us to discuss your specific SSO requirements for self-hosted deployments.