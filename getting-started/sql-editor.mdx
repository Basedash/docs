...
## Next steps
- [Create dashboards](/getting-started/create-dashboard) from your queries
- [Invite team members](/getting-started/invite-team) to collaborate
- Learn about [connecting data sources](/getting-started/connect-data)
