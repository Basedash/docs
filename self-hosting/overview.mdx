...
4. **Choose deployment method** - Select the deployment approach that fits your infrastructure (see [Deploy](/self-hosting/deploy) for options)
...
Self-hosting is currently available on the Enterprise plan. To request access or learn more about this option, please contact us at [support@basedash.com](mailto:support@basedash.com).

For general pricing information, visit our [pricing page](https://basedash.com/pricing).
