...
5. Pull and run Basedash:
   ...
   <Tip>
   On initial deployment, run without `-d` to inspect logs in real-time. Configuration errors may prevent the app from running. See the [Configure](/self-hosting/configure) section for setup details.
   </Tip>
